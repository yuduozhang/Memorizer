...
using namespace std; // qualified prefered
...
auto_ptr <vector<string>> split(const string& s){
...
void test(const WORD& w) {
    WORD word;
    word.setKey();
    w.setKey(); // not compiled
}
